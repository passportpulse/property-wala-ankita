          ...
          <form className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input type="checkbox" className="h-4 w-4 text-coral-red border-slate-300 rounded focus:ring-coral-red" />
                <label className="ml-2 block text-xs font-bold text-slate-500 uppercase tracking-tighter">Remember me</label>
              </div>
              <div className="text-xs">
                <a href="#" className="font-bold text-coral-red hover:text-soft-orange uppercase tracking-tighter">Forgot password?</a>
              </div>
            </div>
