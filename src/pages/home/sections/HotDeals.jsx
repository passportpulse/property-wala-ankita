      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 bg-white shadow-[0_40px_100px_-20px_rgba(253,138,107,0.1)] rounded-[2.5rem] overflow-hidden border border-slate-100">
          ...
          <div className="lg:col-span-4 p-8 lg:p-14 flex flex-col justify-between border-r border-slate-100">
            <div className="space-y-10">
              <div>
                ...
                <h1 className="text-3xl lg:text-4xl font-black text-slate-900 tracking-tighter leading-tight">
                  High-Value <br />
                  <span className="text-transparent bg-clip-text bg-linear-to-r from-coral-red to-soft-orange">Opportunities</span>
                </h1>
              </div>
            ...
            <div className="pt-8">
              <button className="flex items-center gap-3 text-[10px] font-black uppercase tracking-[0.2em] text-slate-900 hover:text-coral-red transition-colors group">
                ...
                <div className="animate-in fade-in slide-in-from-bottom-6 duration-700">
                  <div className="flex items-center gap-6 text-white/90 mb-6 text-[10px] font-black uppercase tracking-[0.2em]">
                    <span className="flex items-center gap-2">
                      <MapPin className="w-4 h-4 text-coral-red" /> {deals[active].location}
                    </span>
                    <span className="flex items-center gap-2">
                      <Maximize2 className="w-4 h-4 text-coral-red" /> {deals[active].sqft}
                    </span>
                  </div>

                  <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
                    <div className="space-y-1">
                      <p className="text-white/60 text-[10px] font-black uppercase tracking-[0.2em]">Exclusive Deal Price</p>
                      <h3 className="text-5xl lg:text-6xl font-black text-white tracking-tighter">{deals[active].price}</h3>
                    </div>

                    <button className="bg-linear-to-r from-coral-red to-soft-orange text-white px-10 py-5 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] hover:scale-105 transition-all shadow-2xl shadow-coral-red/20">
                      Request Portfolio
                    </button>
                  </div>
                </div>
