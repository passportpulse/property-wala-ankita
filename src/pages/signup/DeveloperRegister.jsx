...
export default function DeveloperRegister() {
  ...
  const handleNext = async (e) => {
    ...
    // Extracting values dynamically from the Form elements
    const repName = form.querySelector('input[placeholder*="Vikram Singh"]')?.value || "Developer";
    const compName = form.querySelector('input[placeholder*="Skyline Developers"]')?.value || "Developer Firm";
