...
export default function BestBuyModal({ item, onClose }) {
  ...
  const handleWhatsApp = () => {
    const phone = item.owner?.phone || "911234567890";
    const text = `Hi, I am interested in your "Best Buy" property: ${item.title} listed on Property Wala.`;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="p-7 md:p-10">
          ...
          <p className="mt-6 text-slate-600 text-sm leading-relaxed whitespace-pre-line">
            {item.description || "No description provided for this exclusive deal."}
          </p>
