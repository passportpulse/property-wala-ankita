...
const BundleModal = ({ activeBundle, onClose }) => {
  if (!activeBundle) return null;

  // Support both dynamic activeBundle object and static key lookup
  const data = typeof activeBundle === 'string' ? bundleDetails[activeBundle] : activeBundle;
